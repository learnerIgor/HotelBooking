namespace Booking.Domain
{
    public class Address
    {
        ...
        public Address(Guid addressId, string street, string houseNumber, decimal latitude, decimal longitude, bool isActive, Guid cityId)
        {
            if(addressId == Guid.Empty)
            {
                throw new ArgumentException("AddressId is empty", nameof(addressId));
            }
