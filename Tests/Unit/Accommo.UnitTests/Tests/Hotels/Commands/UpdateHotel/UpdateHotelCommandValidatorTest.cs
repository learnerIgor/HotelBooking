...
{
    public class UpdateHotelCommandValidatorTest : ValidatorTestBase<UpdateHotelCommand>
    {
        public UpdateHotelCommandValidatorTest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }

        protected override IValidator<UpdateHotelCommand> TestValidator => TestFixture.Create<UpdateHotelCommandValidator>();

        [Fact]
        public void Should_BeValid_When_CommandIsValid()
        {
            // arrange
            var payLoad = new UpdateHotelPayload
            {
            ...
            var command = new UpdateHotelCommand
            {
                ...
                Address = new GetAddressExternalDto
                {
                    ...
                    City = new GetCityExternalDto
                    {
                        CityId = payLoad.Address.City.CityId,
                        Name = payLoad.Address.City.Name,
                        Country = new GetCountryExternalDto
                        {
                            CountryId = payLoad.Address.City.Country.CountryId,
                            Name = payLoad.Address.City.Country.Name
                        }
                    }
                }
            };
