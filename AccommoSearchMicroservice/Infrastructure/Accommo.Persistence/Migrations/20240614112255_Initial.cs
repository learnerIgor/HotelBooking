...
namespace Accommo.Persistence.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Hotels",
                columns: new[] { "HotelId", "Name", "Description", "Rating", "IsActive", "Image", "AddressId" },
                values: new object[,]
                {
                    { "35f37340-f9e5-4118-b949-08dc51cc57b7", "Roma Camping In Town", "Комплекс для отдыха Roma Camping In Town расположен всего в 15 минутах езды от Ватикана. К услугам гостей сезонный открытый бассейн, гидромассажная ванна и бар у бассейна.", 5, true, "https://www.example.com", "d078823a-95b4-4bc7-b9a6-a8543b973db9" },
                    { "35f37340-f9e5-4118-b949-08dc51cc57b8", "Hotel Via Veneto", "Hotel Via Veneto — это отель в городе Рим, в 700 м от такой достопримечательности, как Площадь Пьяцца Барберини.", 5, true, "https://www.example.com", "73cd0dc9-eb12-4022-894e-6bb295b6c8e7" },
                });
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "ReservationId", "CheckInDate", "CheckOutDate", "IsActive", "RoomId" },
                values: new object[,]
                {
                    { "35f37347-f9e5-4118-b949-08dc51cc57b2", DateTime.UtcNow, DateTime.UtcNow.AddDays(7), true, "35F37340-F9E5-4118-B949-08DC51CC57B1" },
                    { "35f37000-f9e5-4118-b949-08dc51cc57b2", DateTime.UtcNow.AddDays(2), DateTime.UtcNow.AddDays(14), true, "35F37340-F9E5-4118-B949-08DC51CC57B2" },
                    { "dc70b57b-7803-415f-99df-44f574187539", DateTime.UtcNow, DateTime.UtcNow.AddDays(10), true, "35f37340-f9e5-4118-b949-08dc51cc57b4" },
                    { "1114d20e-e6d4-4308-9d76-afbe7050994c", DateTime.UtcNow.AddDays(17), DateTime.UtcNow.AddDays(27), true, "35F37340-F9E5-4118-B949-08DC51CC57B1" },
                    { "2f1bbdec-b04a-4dab-9860-ff2dd4b9da55", DateTime.UtcNow.AddDays(21), DateTime.UtcNow.AddDays(42), true, "35F37340-F9E5-4118-B949-08DC51CC57B2" },
                    { "abcbaf91-62d2-4d18-83f9-b32fc0444f96", DateTime.UtcNow, DateTime.UtcNow.AddDays(10), true,  "35F37340-F9E5-4118-B949-08DC51CC57B3" },
                    { "148e326b-710e-4610-833c-787af8b4f316", DateTime.UtcNow.AddDays(15), DateTime.UtcNow.AddDays(30), true, "35f37340-f9e5-4118-b949-08dc51cc57b4" },
                    { "318183e9-86be-480e-8e03-d97aa9813230", DateTime.UtcNow.AddDays(35), DateTime.UtcNow.AddDays(50), true, "35F37340-F9E5-4118-B949-08DC51CC57B3" },
                    { "cceacc72-c17b-41bc-9cc1-bbfbaca484c5", DateTime.UtcNow.AddDays(31), DateTime.UtcNow.AddDays(45), true, "35f37340-f9e5-4118-b949-08dc51cc57b4" },
                    { "09dafdd0-6c9c-416f-a3d7-7c47467c4e31", DateTime.UtcNow.AddDays(30), DateTime.UtcNow.AddDays(37), true, "35F37340-F9E5-4118-B949-08DC51CC57B1" },
                    { "b6268ce1-f1a6-4782-a864-466df4677041", DateTime.UtcNow.AddDays(50), DateTime.UtcNow.AddDays(64), true, "35F37340-F9E5-4118-B949-08DC51CC57B2" },
                    { "e38e35b6-379c-47e2-83d0-75f19425c9bb", DateTime.UtcNow.AddDays(11), DateTime.UtcNow.AddDays(30), true,  "35F37340-F9E5-4118-B949-08DC51CC57B3" },
                });
